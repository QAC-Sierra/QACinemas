...
<CRow xs={{ cols: 1 }} md={{ cols: 3 }} className="g-3">
  ...
  <CCol xs>
	<br></br>
    {/* <CCard className="h-100" id="Card1"> */}
	  <CCardImage id="building" src="https://dr3h7ptpe31k5.cloudfront.net/Assets/images/5202/Serviced-Office-(Creative)-London-London-1-St.-Katharines-Way-1275861.jpg" />
    {/* </CCard> */}
  </CCol>
...
<CRow xs={{ cols: 1 }} md={{ cols: 3 }} className="g-3">
  ...
  <CCol xs>
	<br></br>
    {/* <CCard className="h-100" id="Card3"> */}
	  	<CCardImage id="building" src="https://assets.savills.com/properties/67877EC7-C24A-43DC-B47F-761D353B51A9/2021_02_26-0889_l_gal.jpg" />
    {/* </CCard> */}
  </CCol>
...
<header>
			...
			<h5>Here you can find directions to the venue, information on local public transport and parking.</h5>
		</header>
